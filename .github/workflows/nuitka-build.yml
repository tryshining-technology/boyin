  ...
  build-windows:
      ...
      matrix:
        include:
          - python-version: '3.8.10'
            ...
            output-dir-name: 'boyin_win32'

          - python-version: '3.8.10'
            architecture: 'x64'
            artifact-name: 'boyin-Windows-x64-for-Win7'
            output-dir-name: 'boyin_win64_py38'

          - python-version: '3.11'
            architecture: 'x64'
            artifact-name: 'boyin-Windows-x64-for-Win8.1+'
            output-dir-name: 'boyin_win64_py311'
    ...
    steps:
      ...
      - name: Rename executable
        run: |
          Rename-Item -Path "${{ matrix.output-dir-name }}/boyin.dist/boyin.exe" -NewName "创翔多功能定时播音旗舰版.exe"
        shell: pwsh
      ...
      - name: Upload artifact (${{ matrix.artifact-name }})
        ...
        with:
          ...
          path: ${{ matrix.output-dir-name }}/boyin.dist/
