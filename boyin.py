...
#第9部分
    ...
    def _intercut_worker(self):
        """
        专用于处理插播任务的后台线程（最终版：使用事件等待，彻底解决卡死问题）。
        """
        ...
        while self.running:
            ...
            try:
                ...
                try:
                    ...
                    # 将事件处理类连接到 speaker
                    win32com.client.WithEvents(speaker, VoiceEvents)
